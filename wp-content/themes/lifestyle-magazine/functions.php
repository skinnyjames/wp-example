...
function lifestyle_magazine_scripts() {
	...
	wp_enqueue_style( 'lifestyle-magazine-style', get_template_directory_uri() . '/style.css?1.0.1' );
    ...
    wp_enqueue_script('jquery-validator', get_template_directory_uri() . '/js/jquery.validate.min.js', array('jquery'), '', true);
